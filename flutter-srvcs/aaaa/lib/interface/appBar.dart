...
new GestureDetector(
    ...
    child :Container(
      ...
      child: Transform(
        ...
        child: Container(
          padding: EdgeInsets.all(15.15),
          color: Color(0x99FFFFFFF),
          child: new Text("Fotograf Yükleme ",
          textAlign: TextAlign.center,),
        ),
      )
  ...
  new GestureDetector(
  onTap: ()=> Navigator.pushNamed(context, "/Bharita"),
...
new GestureDetector(
  onTap: ()=> Navigator.pushNamed(context, "/MapSample"),
    ...
    child :Container(
      ...
      child: Transform(
        ...
        child: Container(
          padding: EdgeInsets.all(15.15),
          color: Color(0x99FFFFFFF),
          child: new Text("Uzaydan çekim Harita",
          textAlign: TextAlign.center,),
        ),
      )
